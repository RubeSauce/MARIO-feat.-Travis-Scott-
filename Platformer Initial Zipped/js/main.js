...
function Hero(game, x, y) {
    ...
    this.animations.add('die', [4,4, 4, 4, 4, 4, 4, 4], 12); // 12fps no loop
    // starting animation
...
LoadingState.preload = function () {
    ...
    this.game.load.spritesheet('hero', 'images/hero.png', 50, 38);
    ...
    this.game.load.audio('sfx:jcole', 'audio/jcole.wav');
...
PlayState.create = function () {
    ...
    this.sfx = {
        ...
        jcole: this.game.add.audio('sfx:jcole'),
